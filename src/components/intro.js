...
export default function Intro(){  
  ...
  return (
    <div className="StartPage">
      ...
      <h1 className="IntroMsg">I'm glad you're here, My name's <a>Talha Al Rashid</a> and I'm a <a className='SDE'>Software Development Engineer</a>. Feel free to contact me if you have any questions. Take a look around and let me know what you think. I hope you enjoy your visit</h1>
      <div className='Icons'>
